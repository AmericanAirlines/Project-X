...
const axiosGetSpy = jest.spyOn(axios, 'get').mockResolvedValueOnce({ data: testDiscordUser });
const axiosPostSpy = jest.spyOn(axios, 'post').mockResolvedValueOnce({ data: testResponse });
