...
export class Migration20210927234531 extends Migration {
  async up(): Promise<void> {
    ...
    //in above query, add fields: 
    //"pronouns" text not null, "location" text, "hireable" boolean, "purpose" text not null, "schoolName" text not null, "major" text not null, "graduationDate" date(0) not null
  }
